...
- 姓名：刘子奥
- 学号：24012399
- 已完成路由或接口：1.页面路由：/login、/logout、/dashboard、/assistant、404 页面;2.数据API接口：/api/metrics、/api/categories;3.问答接口：/api/ask;4.健康检测路由：/health.
- 测试文件：tests/test_api.py
- 尚未解决的问题：无其他业务功能bug，页面、接口、筛选、问答功能均可正常访问使用。